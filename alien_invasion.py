...
class AlienInvasion:
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # Remove for any bullets and aliens that have collided.
    ...
    def _update_aliens(self):
        ...
        # Look for alien has reached the bottom of the screen.
        self._check_aliens_bottom()
    
    def _check_aliens_bottom(self):
        """Cheack if any aliens have reached the bottom of the screen."""
        for alien in self.aliens.sprites():
